...
export const headlines = [
  ...
  title: "🚨 $300M+ Coinbase Hacker Accumulates Over $14.8M in ETH",
...
},
{
  ...
  title: "🪂 Hidden Airdrop Alert: DropsBot Reveals Unclaimed Rewards Missed by Other Tools",
  summary: "Users are uncovering surprise airdrops using DropsBot — including $165+ that went undetected by popular airdrop checkers.",
  insight:
    "A growing number of crypto users are reporting successful discoveries of unclaimed airdrops using [DropsBot](https://www.drops.bot/), a new tool that scans wallet histories across multiple chains. Unlike traditional checkers, DropsBot aggregates obscure token distributions and low-profile campaigns often missed by mainstream platforms.\n\nOne user recently found $165 in unclaimed rewards through the platform — a sum that wasn't flagged by other top-tier airdrop checkers. DropsBot also provides notification features for future eligibility, making it a go-to utility for airdrop hunters.\n\nAs airdrop season heats up, tools like DropsBot are becoming essential for maximizing hidden crypto rewards and not leaving money on the table.",
  source: "https://www.drops.bot/"
},
{
  id: "linea-tge-bullish",
  title: "🚀 Linea TGE Sparks Bullish Predictions as Sharplink and ConsenSys Align on Massive ETH Moves",
  ...
  insight:
    "The crypto community is buzzing with bullish sentiment as @LineaBuild gears up for its highly anticipated Token Generation Event (TGE). Key developments suggest a major launch on the horizon:\n\n✅ Sharplink Gaming now holds over 280,000 ETH, reportedly with support from @Consensys.\n✅ Linea, a zkEVM L2 scaling solution, is a project from ConsenSys.\n✅ Sharplink has reposted Linea updates, hinting at deeper alignment.\n✅ A massive $5B ETH purchase raise is reportedly in the pipeline.\n\nWith Ethereum showing strong upward momentum, speculation is mounting that Sharplink could migrate part of its ETH holdings to Linea — possibly to bootstrap liquidity or governance. Meanwhile, Linea's tokenomics are set to be revealed this July, increasing airdrop anticipation.\n\nAll signs — ETH alignment, whale accumulation, strategic partnerships — are pointing to a bullish outcome for Linea's TGE. The long-awaited airdrop may finally deliver a win for early supporters.",
  source: "https://x.com/CryptoTeluguO/status/1946910589030461859"
},
{
  id: "pump-airdrop-announced",
  title: "📢 JUST IN: Pump.fun CEO Confirms $PUMP Airdrop for Solana Users on July 24",
